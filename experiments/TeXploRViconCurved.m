...
for i=1:10:840
    ...
    plot3(xarc1,yarc1,zarc1, 'Color', [0 j 1])
    hold on
    [center2, radius2, xarc2, yarc2, zarc2] = triangle2semicircle(arc2p1(i,:), arc2p2(i,:), arc2p4(i,:), pi/2, 3*pi/2);
    plot3(xarc2,yarc2,zarc2, 'Color', [1 0 j])
    hold on
    j = j+0.012;
end
...
function [center, radius, x, y, z] = triangle2semicircle(P1, P2, P3, tstart, tend)
    % Describe the edges of the triangle by defining two vectors from P1
    u = P2 - P1;
    v = P3 - P1;
